"""
Django settings for crimson_union_41117 project.
...
ROOT_URLCONF = 'crimson_union_41117.urls'
...
WSGI_APPLICATION = 'crimson_union_41117.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "crimson_union_41117 API",
    "DESCRIPTION": "API documentation for crimson_union_41117 App",
    "VERSION": "v1",
}
